...
class GridBlock(BaseLayoutBlock):
    ...
    fluid = blocks.BooleanBlock(required=False, label=_("Full width"))
...
class HeroBlock(BaseLayoutBlock):
    ...
    fluid = blocks.BooleanBlock(required=False, default=True, label=_("Full width"))
    ...
    tile_image = blocks.BooleanBlock(
        required=False, default=False, label=_("Tile background image")
    )
