...
class CardBlock(BaseBlock):
    ...
    class Meta:
        template = 'core/blocks/card_foot.html'
        icon = 'fa-list-alt'
        label = _('Card')
...
class CarouselBlock(BaseBlock):
    ...
    """
    carousel = SnippetChooserBlock('coderedcmscore.Carousel')

    class Meta:
        icon = 'image'
        label = _('Carousel')
        template = 'core/blocks/carousel_block.html'
...
class ImageGalleryBlock(BaseBlock):
    ...
    class Meta:
        template = 'core/blocks/image_gallery_block.html'
        icon = 'image'
...
class NavPageLinkBlock(NavBaseLinkBlock):
    ...
    class Meta:
        template = 'core/blocks/page_link_block.html'
        label = _('Page Link')
...
class NavDocumentLinkBlock(NavBaseLinkBlock):
    ...
    class Meta:
        template = 'core/blocks/document_link_block.html'
...
class PageListBlock(BaseBlock):
    ...
    class Meta:
        template = 'core/blocks/pagelist_block.html'
        icon = 'list-ul'
...
class PriceListItemBlock(BaseBlock):
    ...
    class Meta:
        template = 'core/blocks/pricelistitem_block.html'
        icon = 'fa-usd'
...
class PriceListBlock(BaseBlock):
    ...
    class Meta:
        template = 'core/blocks/pricelist_block.html'
        icon = 'fa-usd'
        label = _('Price List')
...
class ContentWallBlock(BaseBlock):
    ...
    """
    content_wall = SnippetChooserBlock('coderedcmscore.ContentWall')
    ...
    class Meta:
        ...
        template = 'core/blocks/content_wall_block.html'
...
class ReusableContentBlock(BaseBlock):
    ...
    """
    content = SnippetChooserBlock('coderedcmscore.ReusableContent')

    class Meta:
        icon = 'fa-recycle'
        label = _('Reusable Content')
        template = 'core/blocks/reusable_content_block.html'
