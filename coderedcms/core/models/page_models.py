...
from coderedcms.core import schema, utils
from coderedcms.core.blocks import (
    CONTENT_STREAMBLOCKS,
    LAYOUT_STREAMBLOCKS,
    ContentWallBlock,
    OpenHoursBlock,
    StructuredDataActionBlock)
from coderedcms.core.forms import CoderedFormBuilder, CoderedSubmissionsListView
from coderedcms.core.models.wagtailsettings_models import GeneralSettings, LayoutSettings, SeoSettings
...
class CoderedPageMeta(PageBase):
    def __init__(cls, name, bases, dct):
        ...
        if 'search_template' not in dct:
            cls.search_template = 'core/pages/search_result.html'
...
class CoderedFormPage(CoderedWebPage):
    ...
    landing_page_template = 'core/pages/form_page_landing.html'
