...
DEFAULTS = {
    ...
    'FRONTEND_TEMPLATES_PAGES': {
        ...
        '*': (
            ('', 'Default'),
            ('core/pages/web_page.html', 'Web page showing title and cover image'),
            ('core/pages/web_page_notitle.html', 'Web page without title and cover image'),
            ('core/pages/base.html', 'Blank page - no navbar or footer'),
        ),
