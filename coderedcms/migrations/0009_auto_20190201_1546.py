...
class Migration(migrations.Migration):
    ...
    dependencies = [("coderedcms", "0008_auto_20190122_1242")]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                choices=[
                    ("", "Default Ordering"),
                    ("-first_published_at", "Date first published, newest to oldest"),
                    ("first_published_at", "Date first published, oldest to newest"),
