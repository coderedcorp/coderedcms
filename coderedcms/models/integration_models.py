    ...
    def build_list_library(self):
        ...
        if mailchimp.is_active:
            ...
            for l in lists["lists"]:
                ...
                list_library[l["id"]]["merge_fields"] = mailchimp.get_merge_fields_for_list(
                    l["id"]
                )["merge_fields"]
                list_library[l["id"]][
                    "interest_categories"
                ] = mailchimp.get_interest_categories_for_list(l["id"])["categories"]
...
class MailchimpSubscriberIntegration(models.Model):
    ...
    panels = [FieldPanel("subscriber_json_data", widget=MailchimpSubscriberIntegrationWidget)]
