...
class Carousel(ClusterableModel):
    ...
    show_indicators = models.BooleanField(
        ...
        help_text=_(
            "Shows small indicators at the bottom of the carousel based on the number of slides."  # noqa
        ),
    )
...
class CarouselSlide(Orderable, models.Model):
    ...
    custom_css_class = models.CharField(
        max_length=255, blank=True, verbose_name=_("Custom CSS class")
    )
    custom_id = models.CharField(max_length=255, blank=True, verbose_name=_("Custom ID"))
...
class ClassifierTerm(Orderable, models.Model):
    ...
    classifier = ParentalKey(Classifier, related_name="terms", verbose_name=_("Classifier"))
    slug = models.SlugField(allow_unicode=True, unique=True, verbose_name=_("Slug"))
    name = models.CharField(max_length=255, verbose_name=_("Name"))
...
class Navbar(models.Model):
    ...
    custom_id = models.CharField(max_length=255, blank=True, verbose_name=_("Custom ID"))
    menu_items = StreamField(NAVIGATION_STREAMBLOCKS, verbose_name=_("Navigation links"))

    panels = [
        FieldPanel("name"),
        MultiFieldPanel(
            [FieldPanel("custom_css_class"), FieldPanel("custom_id")], heading=_("Attributes")
        ),
...
class Footer(models.Model):
    ...
    custom_id = models.CharField(max_length=255, blank=True, verbose_name=_("Custom ID"))
    content = StreamField(LAYOUT_STREAMBLOCKS, verbose_name=_("Content"))
...
class ContentWall(models.Model):
    ...
    name = models.CharField(max_length=255, verbose_name=_("Name"))
    content = StreamField(LAYOUT_STREAMBLOCKS, verbose_name=_("Content"))
    is_dismissible = models.BooleanField(default=True, verbose_name=_("Dismissible"))
    ...
    panels = [
        MultiFieldPanel(
            [FieldPanel("name"), FieldPanel("is_dismissible"), FieldPanel("show_once")],
