...
class CarouselSlide(Orderable, models.Model):
    ...
    custom_id = models.CharField(
        max_length=255, blank=True, verbose_name=_("Custom ID")
    )
...
class ClassifierTerm(Orderable, models.Model):
    ...
    classifier = ParentalKey(
        Classifier, related_name="terms", verbose_name=_("Classifier")
    )
    slug = models.SlugField(allow_unicode=True, unique=True, verbose_name=_("Slug"))
    name = models.CharField(max_length=255, verbose_name=_("Name"))
...
class Navbar(models.Model):
    ...
    menu_items = StreamField(
        NAVIGATION_STREAMBLOCKS, verbose_name=_("Navigation links")
    )

    panels = [
        FieldPanel("name"),
        MultiFieldPanel(
            [FieldPanel("custom_css_class"), FieldPanel("custom_id")],
