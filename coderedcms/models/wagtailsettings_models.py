...
class SocialMediaSettings(BaseSetting):
    ...
    facebook = models.URLField(
        blank=True, verbose_name=_("Facebook"), help_text=_("Your Facebook page URL")
    )
    twitter = models.URLField(
        blank=True, verbose_name=_("Twitter"), help_text=_("Your Twitter page URL")
    )
    ...
    linkedin = models.URLField(
        blank=True, verbose_name=_("LinkedIn"), help_text=_("Your LinkedIn page URL")
    )
...
class LayoutSettings(BaseSetting):
    ...
    navbar_search = models.BooleanField(
        default=True, verbose_name=_("Search box"), help_text=_("Show search box in navbar")
    )
    ...
    panels = [
        MultiFieldPanel(
            [ImageChooserPanel("logo"), ImageChooserPanel("favicon")], heading=_("Branding")
        ),
        MultiFieldPanel(
            [
        ...
        MultiFieldPanel([FieldPanel("frontend_theme")], heading=_("Theming")),
    ]
...
class AnalyticsSettings(BaseSetting):
    ...
    panels = [
        MultiFieldPanel(
            [FieldPanel("ga_tracking_id"), FieldPanel("ga_track_button_clicks")],
...
class ADASettings(BaseSetting):
    ...
    panels = [MultiFieldPanel([FieldPanel("skip_navigation")], heading=_("Accessibility"))]
...
class GeneralSettings(BaseSetting):
    ...
    search_num_results = models.PositiveIntegerField(
        default=10, verbose_name=_("Number of results per page")
    )

    panels = [
        MultiFieldPanel([FieldPanel("from_email_address")], _("Email")),
        MultiFieldPanel([FieldPanel("search_num_results")], _("Search Settings")),
    ]
