...
#
html_sidebars = {
    "**": ["searchbox.html", "globaltoc.html", "relations.html", "versions.html"]
}

html_context = {"css_files": ["_static/docs.css"]}
...
latex_documents = [
    (master_doc, "CodeRedCMS.tex", "CodeRed CMS Documentation", "CodeRed LLC", "manual")
]
...
man_pages = [(master_doc, "coderedcms", "CodeRed CMS Documentation", [author], 1)]
