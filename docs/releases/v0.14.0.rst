...
* New projects created with ``wagtailcrx start`` include a ``.gitignore`` file that ignores
...
* Some blocks within wagtailcrx/blocks/content_blocks.py have been moved to wagtailcrx/blocks/html_blocks.py.
