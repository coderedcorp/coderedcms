...
* Static css/js files have been moved. If you are referencing them manually in your
  templates, please update accordingly:
    ...
    * ``css/codered-front.css`` -> ``wagtailcrx/css/codered-front[.min].css``
    * ``js/codered-front.js`` -> ``wagtailcrx/js/codered-front.js``


Thank You
---------

Special thank you to our new `contributors <https://github.com/coderedcorp/wagtailcrx/graphs/contributors>`_
